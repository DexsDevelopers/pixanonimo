...
import { Sparkles, Star, ShoppingCart, RefreshCw, Search, Filter, Package, TrendingUp, Award, ChevronDown, X, ExternalLink, Check } from 'lucide-react';
        ...
        {step === 1 ? (
          ...
          <div className="p-5 space-y-4 text-center">
            ...
            <div className="flex items-center gap-2 justify-center p-3 bg-green-500/10 border border-green-500/20 rounded-xl">
              ...
              <p className="text-xs text-green-400 font-semibold">Pagamento será confirmado automaticamente</p>
            </div>
