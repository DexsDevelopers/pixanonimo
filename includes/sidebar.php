...
<div class="mobile-header">
    <div class="logo">
        <img src="<?php echo $base_path; ?>logo_premium.png?v=102.0" class="logo-img" alt="Ghost Logo">
        ...
        <div class="sidebar-footer">
            <div class="user-profile">
                <div class="avatar" style="overflow: hidden; border: 1.5px solid var(--border-h);">
                    <img src="<?php echo $base_path; ?>logo_premium.png?v=102.0" class="avatar-img" alt="Avatar">
                </div>
                <div class="user-info">
